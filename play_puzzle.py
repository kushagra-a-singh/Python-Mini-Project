...
#    letters = puzl.get('letters')
    ...
    while True:
        ...
        # user need some help
        if guess.startswith('!'):
            display_help(guess, letters, guess_list, player_score, player_words, player_pangram, total_score, word_count)
            continue
...
def display_help(msg, letters, guess_list, player_score, player_words, player_pangram, total_score, word_count, puzl):
    ...
    if clean_msg == 'q':
        print("Answers for the current puzzle:")
        solve_puzzle.solve(puzl)

        print("\nOptions:")
        print("1. Play another quiz")
        print("2. Exit game")
